							...
							if (strlen($items[32]) > 1)
								...
								if($items[32] == "Tourn")
									$tourn = true;
															 ...
															 //DB - season_id,game_id,   datetime,loc,opponent,   result,      details,tournamenent game,run_scored,run_allowed,rs1-9,rsex,lob,error,ra1-9,raex, opplob, opperr,updated
...
//				echo "extra line read $$buffer. <br>";
	...
	if (($uploadOk == 0) || ($name_missing == true))
		{
...
echo "<br><a href=\"loadstatsfile_main.php\">Return to Load Stat File Page</a><br>";
