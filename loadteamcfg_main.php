...
<html>
    <head>
        <title>Load Team Config Page</title>
...
<div class="row justify-content-md-center">
	<h1 style="text-align:center" id="pageheader">Load Team Config (Creates a Team) Page</h1>
</div>	
...
<div id="main" class="main">		
	<table border='0'>
		...
		<col width="33%">		
		<tr><td></td><td>
			<form action="loadteamcfg_db.php" method="post" enctype="multipart/form-data">
