...
$SQLquery  = "SELECT * FROM pitchers h JOIN players p ON h.player_id=p.player_id JOIN games g ON g.game_id=h.game_id WHERE g.season_id=$season_num AND p.player_id=$player_num";
