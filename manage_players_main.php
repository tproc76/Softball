...
<html>
	<head>
		...
		<script type="text/javascript" src="manage_players.js"></script>
	</head>
<body>
...
$select =mysqli_query($link, "SELECT * FROM players");
?>

<!--top-header-->
<div class="row justify-content-md-center">
	<h1 id="playerheader">Player List</h1>
	<BR><BR>
</div>	
...
<div class="row justify-content-md-center">
	...
	while ($row=mysqli_fetch_array($select, MYSQLI_ASSOC)) 
	 ...
	 ?>
		<tr id="row<?php echo $row['player_id'];?>">
			<td id="name_nick<?php echo $row['player_id'];?>"><?php echo $row['nickname'];?></td>
			<td id="name_full<?php echo $row['player_id'];?>"><?php echo $row['fullname'];?></td>
			<td id="notes<?php echo $row['player_id'];?>"><?php echo $row['notes'];?></td>
			<td>
	...
	?>
		...
		<tr id="new_row">
			 ...
			 <td><input type="text" id="new_notes"></td>
